...
function linkAccount(user, context, callback) {
  /**
   * This rule has been automatically generated by
   * Unknown at 2020-10-27T17:12:49.385Z
   */
  ...
  var config = {
    endpoints: {
      linking: 'https://hanja-dev.us.webtask.run/4cb95bf92ced903b9b84ebedbf5ebffd',
      userApi: auth0.baseUrl + '/users',
      usersByEmailApi: auth0.baseUrl + '/users-by-email',
    },
    token: {
      clientId: 'meU129Q7ZBVYRAIC0Bskil2bUuwzpRZy',
      clientSecret: 'pB1XMtfG-sw5vfJKe5vRwV6faY1Vrd2F61J8i-oMMsAC-vKsOLeZUFx6AEIsm5a_',
      issuer: auth0.domain,
    },
  };
  ...
  function linkAccounts() {
    ...
    return verifyToken(secondAccountToken, config.token.clientSecret).then(function (decodedToken) {
  ...
  function promptUser() {
    return searchUsersWithSameEmail()
      .then(function transformUsers(users) {
        return users
          .filter(function (u) {
